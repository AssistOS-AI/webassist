...
- [webAdmin Skills and Reporting Logic](./specsLoader.html?spec=DS001-skills.md)
- [Skill: update-lead](./specsLoader.html?spec=DS002-skill-update-lead.md)
- [webAdmin Integration and Loading](./specsLoader.html?spec=DS003-integration.md)
- [Skill: lead-info](./specsLoader.html?spec=DS004-skill-lead-info.md)
